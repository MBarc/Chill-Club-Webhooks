...
if mostRecentTweet.created_at < endTime and mostRecentTweet.created_at > startTime:
    webhook = 'https://discordapp.com/api/webhooks/729417210124304424/J2N5sQsu5vZfZDF4pnBu-YM5jn8UnTltT-aRVIQPdIYZ0Kog9JAz-aPBMvzk4M5NmS0E'
    webhookContent = f'https://twitter.com/ACWorldBlog/status/{mostRecentTweet.id}'  # Exception would be here
